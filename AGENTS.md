...
- Current work-package active ExecPlan: `none` (most recently completed: `docs/work-packages/20260317_omni_contrast_hillslope_rerun/prompts/completed/omni_contrast_hillslope_rerun_execplan.md`).
