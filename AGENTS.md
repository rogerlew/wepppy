...
- Current work-package active ExecPlan: `none` (most recently completed: `docs/work-packages/20260321_rusle_c_modes_implementation/prompts/completed/rusle_c_modes_execplan.md`).
