...
- Current work-package active ExecPlan: `none` (most recently completed: `docs/work-packages/20260321_rusle_nodb_ui/prompts/completed/rusle_nodb_ui_execplan.md`).
