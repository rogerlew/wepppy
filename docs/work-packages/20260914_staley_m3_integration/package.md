...
mask plus intermediate records. M3 currently fails `integration_pending`.
...
The [decision register](artifacts/20260914_contract_decision.md) names unresolved
...
security artifacts with no open medium/high findings. Scaffold preparation does
not claim those reviews have run. [ExecPlan](prompts/active/execplan.md) and
[tracker](tracker.md) govern execution.
