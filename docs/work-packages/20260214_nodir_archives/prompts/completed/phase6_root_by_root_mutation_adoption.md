...
Revision Note (2026-02-18, Codex): Historical addendum applied for Phase 9 planning. Phase 6 outcomes remain complete and valid under thaw/freeze contract semantics; forward implementation guidance is superseded by canonical root projection-session contract defined in `docs/work-packages/20260214_nodir_archives/artifacts/nodir_materialization_contract.md` and Phase 9 sections in `docs/work-packages/20260214_nodir_archives/notes/implementation_plan.md`.
