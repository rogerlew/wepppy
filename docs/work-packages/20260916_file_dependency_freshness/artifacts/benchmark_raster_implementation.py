"""Actual C03/C04 acceptance, transparent instrumentation and old-method controls.
...
OUTPUT = ARTIFACTS / 'raster_implementation_performance.json'
...
real_joint = raster_freshness.raster_dependency_signatures
...
try:
    ...
    with patch.object(Path, 'open', counted_open), \
            ...
            patch.object(raster_freshness, 'raster_dependency_signatures', observed), \
            patch.object(landuse_module, 'raster_dependency_signatures', observed), \
