...
def test_characterize_restored_snapshot_modes(owner_project):
    ...
    assert before['snapshot'] == '0o600'
    assert after['directory'] == '0o755' and after['snapshot'] == '0o600'
    for status in root.glob('climate_artifacts/cli_parquet/attempts/*/status.json'):
