...
- Generated (UTC): `2026-09-17T20:05:37Z`
...
- Files analyzed: `2`; highest severity red: `1`, yellow: `1`; worsened metric entries: `1` (exceptions: `0`, actionable: `1`)

| File | Lang | Highest | Key Metric Deltas |
| --- | --- | --- | --- |
| `tests/nodb/test_climate_build_helpers.py` | `python` | `yellow` | python_file_sloc 874->900 (worsened, yellow)<br>python_function_len 86->86 (unchanged, yellow)<br>python_cc n/a->n/a (n/a, unknown) |
| `wepppy/nodb/core/climate_build_helpers.py` | `python` | `red` | python_file_sloc 1320->1318 (improved, red)<br>python_function_len 89->89 (unchanged, yellow)<br>python_cc n/a->n/a (n/a, unknown) |
