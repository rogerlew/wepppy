...
| `landuse` / DOM-08A/08B | `C/landuse.js`; `T/landuse_pure.htm`, `landuse_map.htm`, `landuse_user_defined.htm` | `R/nodb_api/landuse_bp.py`, Landuse; build RQ | DOM-08A: actual upload-mode render, exact FormData, multipart normalization, build/reload; DOM-08B catalog/editor/map remains unverified; high | contractual | documented |
