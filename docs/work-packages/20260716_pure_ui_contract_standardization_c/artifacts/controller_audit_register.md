...
| `omni` / DOM-25A/25B | `C/omni.js`; `T/omni_scenarios_pure.htm` | `R/nodb_api/omni_bp.py`, Omni; `wepppy/rq/omni_rq.py` | DOM-25A actual scenario action/lifecycle render and controller/route/state/worker/reload evidence; DOM-25B queued; high | contractual | partially verified |
