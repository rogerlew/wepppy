...
| `agFields` / DOM-13A..13D | `C/ag_fields.js`; `T/ag_fields_pure.htm` | `R/run_0/run_0_bp.py`, AgFields; `wepppy/rq/ag_fields_rq.py` stage/suite chain | DOM-13A verifies actual boundary/schema/subfield render, browser, route parsing, state and enqueue evidence; DOM-13B-D remain queued; high | contractual | partially verified |
