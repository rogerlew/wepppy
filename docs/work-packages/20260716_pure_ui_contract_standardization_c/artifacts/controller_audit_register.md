...
| `agFields` / DOM-13A..13D | `C/ag_fields.js`; `T/ag_fields_pure.htm` | rq-engine AgFields routes/state; `wepppy/rq/ag_fields_rq.py` stage/suite chain | DOM-13A verifies boundary/schema/subfield, DOM-13B plant/mapping, and DOM-13C staged sub-field WEPP actual render/controller/route/state/worker/reload evidence; DOM-13D remains queued; high | contractual | partially verified |
