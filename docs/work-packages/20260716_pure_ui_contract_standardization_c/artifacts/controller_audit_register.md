...
| `wepp` / DOM-14A..14C | `C/wepp.js`; `T/wepp_pure.htm` plus WEPP/SWAT advanced partials | `R/nodb_api/wepp_bp.py`, Wepp/SWAT; WEPP stage pipeline | DOM-14A core and DOM-14B advanced render/parser/browser/RQ-engine evidence verified; DOM-14C remains queued; high | contractual | partially verified |
