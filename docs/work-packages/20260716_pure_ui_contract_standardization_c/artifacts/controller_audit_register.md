...
| `featuresExport` / DOM-20A/20B | `C/features_export.js`; `T/features_export_pure.htm` | `R/run_0/run_0_bp.py`, service/cache; `features_export_rq.py` | DOM-20A actual catalog/selector/profile/config render plus controller/catalog/profile/planner evidence; DOM-20B queued; high | contractual | partially verified |
