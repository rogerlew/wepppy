...
| SURF-14A | `20260729_user_preferences_wbt_boundary` | Account User Preferences model/page, new-run Unitizer/WBT default snapshot, and configurable WBT DEM-boundary warn/error behavior | SURF-14, SHR-05, DOM-02, DOM-05A | High / `high`: authenticated mutation, database migration, creation propagation, and RQ failure behavior | scaffolded; checkpoint pending |
