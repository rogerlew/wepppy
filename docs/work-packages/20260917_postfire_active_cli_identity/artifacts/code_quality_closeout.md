...
- Generated (UTC): `2026-09-17T19:13:18Z`
...
- Files analyzed: `5`; highest severity red: `0`, yellow: `2`; worsened metric entries: `9` (exceptions: `0`, actionable: `9`)

| File | Lang | Highest | Key Metric Deltas |
| --- | --- | --- | --- |
| `tests/nodb/mods/test_postfire_debris_flow_freshness.py` | `python` | `green` | python_file_sloc 205->325 (worsened, green)<br>python_function_len 28->42 (worsened, green)<br>python_cc n/a->n/a (n/a, unknown) |
...
| `tests/nodb/mods/test_postfire_debris_flow_runtime_m3.py` | `python` | `green` | python_file_sloc 299->393 (worsened, green)<br>python_function_len 47->56 (worsened, green)<br>python_cc n/a->n/a (n/a, unknown) |
| `wepppy/nodb/mods/postfire_debris_flow/production.py` | `python` | `yellow` | python_file_sloc 732->763 (worsened, yellow)<br>python_function_len 110->110 (unchanged, yellow)<br>python_cc n/a->n/a (n/a, unknown) |
| `wepppy/nodb/mods/postfire_debris_flow/run_preparation.py` | `python` | `green` | python_file_sloc 54->56 (worsened, green)<br>python_function_len 44->47 (worsened, green)<br>python_cc n/a->n/a (n/a, unknown) |
