...
- Generated (UTC): `2026-09-17T18:58:42Z`
...
- Files analyzed: `5`; highest severity red: `0`, yellow: `2`; worsened metric entries: `7` (exceptions: `0`, actionable: `7`)

| File | Lang | Highest | Key Metric Deltas |
| --- | --- | --- | --- |
| `tests/nodb/mods/test_postfire_debris_flow_freshness.py` | `python` | `green` | python_file_sloc 205->313 (worsened, green)<br>python_function_len 28->40 (worsened, green)<br>python_cc n/a->n/a (n/a, unknown) |
| `tests/nodb/mods/test_postfire_debris_flow_production.py` | `python` | `yellow` | python_file_sloc 532->564 (worsened, green)<br>python_function_len 111->144 (worsened, yellow)<br>python_cc n/a->n/a (n/a, unknown) |
| `tests/nodb/mods/test_postfire_debris_flow_runtime_m3.py` | `python` | `green` | python_file_sloc 299->364 (worsened, green)<br>python_function_len 47->56 (worsened, green)<br>python_cc n/a->n/a (n/a, unknown) |
| `wepppy/nodb/mods/postfire_debris_flow/production.py` | `python` | `yellow` | python_file_sloc 732->760 (worsened, yellow)<br>python_function_len 110->110 (unchanged, yellow)<br>python_cc n/a->n/a (n/a, unknown) |
| `wepppy/nodb/mods/postfire_debris_flow/run_preparation.py` | `python` | `green` | python_file_sloc 54->54 (unchanged, green)<br>python_function_len 44->44 (unchanged, green)<br>python_cc n/a->n/a (n/a, unknown) |
