...
| [incident-2026-06-16-wepp1-browse-download-slowdown.md](incident-2026-06-16-wepp1-browse-download-slowdown.md) | Incident report for slow archive/file downloads on `wepp1` tied to abnormal `browse` worker memory, timeouts, NFS metadata stalls, and the dedicated archive download service remediation. |
| [incident-2026-08-26-gridmet-html-netcdf.md](incident-2026-08-26-gridmet-html-netcdf.md) | GridMET 502/503 HTML responses published as final NetCDF artifacts during production climate construction. |
