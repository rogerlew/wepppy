...
- State-dependent card content:
  ...
  - `warn` / `fail`: status chip, a plain-language impact statement (derived from severity, see below), the `fix_hint`, and technical `evidence` de-emphasized or behind a disclosure.
