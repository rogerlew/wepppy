...
| Project create | `/create/` (alias `/api/create/`) | Sync redirect (`303`) plus resource creation | `rq:enqueue` token path or CAPTCHA, subject to [creation policy](project-creation-policy.md) opt-in restriction and 403/503 errors |
