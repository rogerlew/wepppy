...
This infrastructure is also directly strengthening the university's core capacity for funding and collaborations. In the last two weeks, the team learned it was awarded two additional grants: a NASA project to develop a gridded WEPP with water-quality capability, and a USGS 104g project to combine satellite-derived suspended sediment estimates with watershed modeling. Both projects use the Coeur d'Alene Basin/Lake as study systems and depend on WEPPcloud-based watershed modeling capacity. More broadly, the WEPPcloud research program currently supports 3 postdocs, 1 research scholar, and 2 research faculty on externally funded soft-money grants. From an administrative perspective, the proposed servers therefore do more than support a single project: they help protect active grant-funded personnel, strengthen tribal and federal collaborations, and expand EPSCoR-aligned institutional capacity to win and execute future awards.
