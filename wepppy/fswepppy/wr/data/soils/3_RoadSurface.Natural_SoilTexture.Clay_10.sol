...
#   Build Date: 2022-08-16 15:09:08.466121
#   Source File: :og/3clay10.sol
# 
# ofe=0,horizon0 bd default value of 1.4
# ofe=0,horizon0 fc estimated using Rosetta(clay=30, sand=30, bd=None, silt=40)
# ofe=0,horizon0 wp estimated using Rosetta(clay=30, sand=30, bd=None, silt=40)
# ofe=0,horizon0 ksat estimated using Rosetta(clay=30, sand=30, bd=None, silt=40)
# ofe=0,horizon0 anisotropy estimated using Rosetta(clay=30, sand=30, bd=None, silt=40)
...
3 0
'Road'	 'clay loam'	 1	 0.6	 0.5	 1500000.0	 0.0002	 10.0
	200	 1.4	 9.5377	 1.0	 0.2849	 0.1635	 30	 30	 0.01	 24	 urr
1 10000.0 9.5377
'Fill'	 'clay loam'	 1	 0.12	 0.45	 1500000.0	 0.0002	 2.0
	300	 1.4	 9.5377	 1.0	 0.2849	 0.1635	 30	 30	 4	 26	 ufr
1 10000.0 9.5377
'Forest'	 'clay loam'	 1	 0.02	 0.4	 10000.0	 0.0002	 2.0
	300	 1.4	 9.5377	 1.0	 0.2849	 0.1635	 30	 30	 8	 27	 ubr
1 10000.0 9.5377