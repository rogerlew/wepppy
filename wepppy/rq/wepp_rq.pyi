...
def get_active_wepp_job(prep: Any, redis_conn: Any) -> dict[str, str] | None: ...
def ensure_no_active_wepp_job(runid: str, prep: Any, redis_conn: Any) -> None: ...
...
def bootstrap_enable_rq(runid: str, actor: str | None = ..., lock_token: str | None = ...) -> dict[str, Any]: ...
