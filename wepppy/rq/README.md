...
- **Dependency catalog.** When editing enqueue sites or dependency edges (`wepppy/rq/*.py`, `wepppy/microservices/rq_engine/*`, or rq-initiated route handlers), update `wepppy/rq/job-dependencies-catalog.md` in the same change.
