...
outlet_locs = {
    ...
    '174': (150.3904197, -34.1589295),
    '176': (150.454035, -34.135170),
    '200': (150.23246, -34.22814),
    '204': (150.320811, -34.184367),
    '220': (150.21148, -34.27796),
    '223': (150.344941, -34.276337),
    '230': (150.38096, -34.20016),
    '231': (149.93706, -34.301980),
    '238': (149.963453, -34.316187),
    '239': (150.22782, -34.25704),
    '249': (150.14092, -34.30062),
    '255': (150.02938, -34.36450)
}

blacklist = [
    '33',   # might be too flat channel map has drainage from over ridge
    '177',  # in gwc_sbs6 map, area needs to be delineated from interface
