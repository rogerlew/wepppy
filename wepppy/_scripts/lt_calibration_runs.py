...
if __name__ == '__main__':
    ...
    watersheds = [
        ...
        dict(watershed='63_Ward_Creek_WC3A', # 1200 ha
             ...
             landuse=None,
             cs=30, erod=0.000001,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=900.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='63_Ward_Creek_WC7A', # 2300 ha
             ...
             landuse=None,
             cs=30, erod=0.000001,
             surf_runoff=0.005, lateral_flow=0.006, baseflow=0.007, sediment=1100.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='19_Incline_Creek_IN2', # 1100 ha
             ...
             landuse=None,
             cs=40, erod=0.000001,
             surf_runoff=0.011, lateral_flow=0.012, baseflow=0.013, sediment=1300.0,
             gwstorage=100, bfcoeff=0.0017, dscoeff=0.0006, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='19_Incline_Creek_IN3', # 740 ha
             ...
             landuse=None,
             cs=45, erod=0.000001,
             surf_runoff=0.010, lateral_flow=0.011, baseflow=0.012, sediment=1300.0,
             gwstorage=100, bfcoeff=0.0022, dscoeff=0.0009, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='43_Trout_Creek_TC2', # 6000 ha
             ...
             landuse=None,
             cs=45, erod=0.000001,
             surf_runoff=0.008, lateral_flow=0.009, baseflow=0.010, sediment=1700.0,
             gwstorage=100, bfcoeff=0.0168, dscoeff=0.0105, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='43_Trout_Creek_TC3', # 1900 ha
             ...
             landuse=None,
             cs=75, erod=0.000001,
             surf_runoff=0.007, lateral_flow=0.008, baseflow=0.009, sediment=1500.0,
             gwstorage=100, bfcoeff=0.01, dscoeff=0.001, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='44_Upper_Truckee_River_UT3', # 10000 ha
             ...
             landuse=None,
             cs=70, erod=0.000001,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1300.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8,
             csa=10),
        dict(watershed='44_Upper_Truckee_River_UT5', # 3700 ha
             ...
             landuse=None,
             cs=180, erod=0.000001,
             surf_runoff=0.007, lateral_flow=0.008, baseflow=0.009, sediment=1300.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8)
    ]
    ...
    for scenario in scenarios:
        for watershed in watersheds:
            ...
            projects[-1]['wd'] = 'lt_202101_%s_%s' % (watershed['watershed'], scenario['scenario'])
