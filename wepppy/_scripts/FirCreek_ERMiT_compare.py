...
if __name__ == '__main__':
    ...
    scenarios = [
        dict(wd='CurCond.202202.cl532.chn_cs{cs}',
             landuse=None,
    ...
    for scenario in scenarios:
        for watershed in watersheds:
            ...
            projects[-1]['wd'] = 'portland_300m_{watershed}_{scenario}' \
