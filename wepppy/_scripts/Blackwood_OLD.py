# Mariana Dobre
# This script runs the Blackwood and Upper Truckee watersheds with 
#       a. original configuration (OLD; lt-wepp_bd16b69-snow.cfg) AND
...
if __name__ == '__main__':
    ...
    watersheds = [
        dict(watershed='44_OLD_300m_Upper_Truckee_River_Big_Meadow_Creek',  # 14000 ha  Watershed_51_SLT
        ...
        dict(watershed='62_OLD_300m_Blackwood_Creek',  # Watershed_9_Blackwood_10336660
