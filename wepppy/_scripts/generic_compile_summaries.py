...
if __name__ == "__main__":
    ...
    parser.add_argument('--outdir', type=str, default='/home/mariana/caldor_csvs', help='outdir for files')
    parser.add_argument('--input_csv', type=str, default='Caldor.csv', help='input file with RunID, WatershedName, Scenario colmans')
