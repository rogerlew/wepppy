...
if __name__ == '__main__':
    projects = [
                dict(wd='RefugioCreek',
                     extent=[-120.12554168701173, 34.44867960606163, -120.00537872314455, 34.547711171145494],
                     map_center=[-120.06546020507814, 34.49821009275094],
                     map_zoom=13,
                     outlet=[-120.06967899021485, 34.46309439596166],
                     landuse=None,
