# Mariana Dobre
# This script runs the JOH calibrated Blackwood and Upper Truckee watersheds with 
#       a. the current configulation (CUR; lt-wepp_latest.cfg) AND
#       b. With the 300m limitation
#       lt-wepp_latest.cfg =  same as lt-wepp_bd16b69-snow.cfg, except, I changed bin = latest
...
if __name__ == '__main__':
    ...
    watersheds = [
        dict(watershed='44_CUR_300m_Upper_Truckee_River_Big_Meadow_Creek',  # 14000 ha  Watershed_51_SLT
        ...
        dict(watershed='62_CUR_300m_Blackwood_Creek',  # Watershed_9_Blackwood_10336660
    ...
    for proj in projects:
        try:
            ...
            watershed.build_channels(csa=5, mcl=60)
            ...
            if climate_mode == 'observed':
                ...
                src_wd = 'lt_202203_%s_%s' % (_watershed, climate_mode[4:])
