...
if __name__ == '__main__':
    ...
    watersheds = [
        ...
        dict(watershed='41_Intervening_Area_Bijou_Park_1',  # 490 ha  Watershed_47
             ...
             landuse=None,
             cs=45, erod=0.000001,
             surf_runoff=0.010, lateral_flow=0.011, baseflow=0.012, sediment=2400.0,
             gwstorage=100, bfcoeff=0.005, dscoeff=0.003, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='41_Intervening_Area_Bijou_Park_2',  # 310 ha  Watershed_48
             ...
             landuse=None,
             cs=45, erod=0.000001,
             surf_runoff=0.010, lateral_flow=0.011, baseflow=0.012, sediment=2000.0,
             gwstorage=100, bfcoeff=0.005, dscoeff=0.003, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
        dict(watershed='42_Bijou_Creek',  # 510 ha  Watershed_49
             ...
             landuse=None,
             cs=45, erod=0.000001,
             surf_runoff=0.010, lateral_flow=0.011, baseflow=0.012, sediment=1900.0,
             gwstorage=100, bfcoeff=0.005, dscoeff=0.003, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.8),
