...
if __name__ == '__main__':
    ...
    watersheds = [
        dict(wd='Watershed_1',
             ...
             gwstorage=100, bfcoeff=0.01, dscoeff=0.00, bfthreshold=1.001,
    ...
    scenarios = [
               ...
               dict(wd='ModSevS.202007.kikrcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 118), (shrub_selector, 120)]),
               dict(wd='HighSevS.202007.kikrcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 105), (shrub_selector, 119)]),
               dict(wd='Thinn96.202007.kikrcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 123)]),
               dict(wd='Thinn93.202007.kikrcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 115)]),
               dict(wd='Thinn85.202007.kikrcs.chn_cs{cs}',
