...
#             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
#             mid_season_crop_coeff=0.80, p_coeff=0.75),
        dict(watershed='DeerCreek',
             extent=[-122.29980468750001, 45.322702747838406, -121.81915283203126, 45.65964739507406],
             map_center=[-122.0593846, 45.491395],
             map_zoom=13,
             outlet=[ -122.059629836431, 45.4915880376504],
             landuse=None,
             cs=140, erod=0.000001,
             csa=10, mcl=100,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1000.0,
        ...
        dict(watershed='CougarCreek',
             extent=[-122.11681365966798, 45.464946600971466, -121.9966506958008,45.54915936139622],
             map_center=[-122.05673217773439, 45.50706872936992],
             map_zoom=13,
             outlet=[-122.062063982209, 45.490662929306],
             landuse=None,
             cs=140, erod=0.000001,
             csa=10, mcl=100,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1000.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.75),
        dict(watershed='BearCreek',
             extent=[-122.132450445788, 45.470506334542456, -122.01228748192081, 45.55471078321761],
             map_center=[-122.0723689638544, 45.51262430701173],
             map_zoom=13,
             outlet=[-122.083958580232, 45.4876362051178],
             landuse=None,
             cs=140, erod=0.000001,
             csa=10, mcl=100,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1000.0,
             gwstorage=100, bfcoeff=0.04, dscoeff=0.00, bfthreshold=1.001,
             mid_season_crop_coeff=0.95, p_coeff=0.75),
        dict(watershed='FivemileCreek',
             extent=[-122.13178721198348, 45.46616694311973, -122.07170573004989, 45.50828815934011],
             map_center=[-122.10174647101668, 45.48723148832426],
             map_zoom=14,
             outlet=[-122.089195164798, 45.4795320152864],
             landuse=None,
             cs=140, erod=0.000001,
             csa=10, mcl=100,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1000.0,
        ...
        dict(watershed='CampCreek',
             extent=[-122.1288455516333, 45.42314347636594, -122.00868258776609, 45.50741870672667],
             map_center=[-122.06876406969968, 45.46529684012209],
             map_zoom=13,
             outlet=[-122.100010269201, 45.4608412428873],
             landuse=None,
             cs=140, erod=0.000001,
             csa=10, mcl=100,
             surf_runoff=0.003, lateral_flow=0.004, baseflow=0.005, sediment=1000.0,
    ...
    for proj in projects:
        ...
        if cli_mode == 'observed':
            ...
            if 'linveh' in wd:
                ...
                climate.climate_spatialmode = ClimateSpatialMode.Multiple
                climate.set_observed_pars(start_year=1980, end_year=2021)
