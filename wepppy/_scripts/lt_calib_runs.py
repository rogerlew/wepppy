...
if __name__ == '__main__':
    ...
    scenarios = [
               dict(wd='SimFire.2020.ki5krcs.chn_cs{cs}_fccsFuels_obs_cli',
                    landuse=None,
                    cfg='lt-fire'),
               dict(wd='SimFire.2020.ki5krcs.chn_cs{cs}_landisFuels_obs_cli',
                    landuse=None,
                   cfg='lt-fire-future'),
               dict(wd='SimFire.2020.ki5krcs.chn_cs{cs}_landisFuels_fut_cli_A2',
                    landuse=None,
                    cfg='lt-fire-future',
                    climate='future'),
               dict(wd='CurCond.2020.cl532.ki5krcs.chn_cs{cs}',
                    landuse=None),
               dict(wd='PrescFireS.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 110), (shrub_selector, 122)]),
               dict(wd='LowSevS.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 106), (shrub_selector, 121)]),
               dict(wd='ModSevS.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 118), (shrub_selector, 120)]),
               dict(wd='HighSevS.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 105), (shrub_selector, 119)]),
               dict(wd='Thinn96.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 123)]),
               dict(wd='Thinn93.2020.ki5krcs.chn_cs{cs}',
                    landuse=[(not_shrub_selector, 115)]),
               dict(wd='Thinn85.2020.ki5krcs.chn_cs{cs}',
    ...
    for scenario in scenarios:
        for watershed in watersheds:
            ...
            projects[-1]['wd'] = 'lt_{watershed}_{scenario}'\
                                 .format(watershed=watershed['wd'], scenario=scenario['wd'])\
