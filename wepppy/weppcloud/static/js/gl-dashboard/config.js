...
export const BASE_LAYER_DEFS = [
  ...
  {
    key: 'rusle-a-observed-rap-epic',
    group: 'rusle',
    label: 'RUSLE A (Observed RAP, EPIC K)',
    paths: ['rusle/a_observed_rap_polaris_epic.tif'],
    colormap: 'jet2',
    units: 't/ha/yr',
  },
  {
    key: 'rusle-a-scenario-sbs-nomograph',
    group: 'rusle',
    label: 'RUSLE A (Scenario SBS, Nomograph K)',
    paths: ['rusle/a_scenario_sbs_polaris_nomograph.tif'],
    colormap: 'jet2',
    units: 't/ha/yr',
  },
  {
    key: 'rusle-a-scenario-sbs-epic',
    group: 'rusle',
    label: 'RUSLE A (Scenario SBS, EPIC K)',
    paths: ['rusle/a_scenario_sbs_polaris_epic.tif'],
    colormap: 'jet2',
    units: 't/ha/yr',
  },
  {
  ...
  {
    key: 'rusle-c-scenario-sbs',
    group: 'rusle',
    label: 'RUSLE C (Scenario SBS)',
    paths: ['rusle/c_scenario_sbs.tif'],
    colormap: 'viridis',
    units: 'unitless',
    valueRange: { min: 0, max: 1 },
  },
  ...
  },
  {
    key: 'rusle-k-epic',
    group: 'rusle',
    label: 'RUSLE K (POLARIS EPIC)',
    paths: ['rusle/k_polaris_epic.tif'],
    colormap: 'plasma',
    units: 't*ha*h/(ha*MJ*mm)',
    valueRange: { min: 0, max: 0.7 },
  },
