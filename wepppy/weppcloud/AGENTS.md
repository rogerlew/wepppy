...
- For template and presentation changes, follow the [established presentation contract](../../docs/ui-docs/controller-contract.md#established-presentation-conventions): inspect a comparable controller and reuse shared macros, layout, filename displays, summaries, and error placement before writing custom markup.
