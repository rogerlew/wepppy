...
def _build_mcp_markdown(
    *,
    ...
    header_lines = [
        ...
        "",
        "⚠️ This file intentionally excludes the bearer token. Use the token returned in the command bar response.",
        "",
        "## Authorization Header",
        "```http",
        "Authorization: Bearer <paste-token-from-command-bar-response>",
        "```",
        "",
        "## Setup Steps",
    ]
