...
_INDEX_DOC_DESCRIPTIONS: Dict[str, str] = {
    ...
    "usersum.weppcloud.wepp_forest_compiler_fragility_brief": "Summarizes compiler/toolchain fragility risks, stakeholder impacts, and the operational policy for stable, observable WEPP releases.",
