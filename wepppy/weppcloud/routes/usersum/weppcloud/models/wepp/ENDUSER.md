...
| `Clip Hillslopes` | `Clip hillslopes`, `Per-OFE hillslope clip length` | Caps each OFE independently and preserves complete representative hillslope area; a multi-OFE hillslope may remain longer than the selected value in total |
