...
def _parse_soil_file(path: Path, *, calendar_lookup: Dict[int, List[Tuple[int, int]]] | None = ...) -> Any: ...

def run_wepp_hillslope_soil_interchange(wepp_output_dir: Path | str, *, expected_hillslopes: int | None = None) -> Path: ...
