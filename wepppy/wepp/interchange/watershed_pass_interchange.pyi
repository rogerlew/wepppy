...
def _parse_metadata(header_lines: List[str]) -> Tuple[Dict[str, object], Any, int, List[int], int, List[str]]: ...
...
def _parse_pass_file(stream: Any) -> Tuple[Dict[str, object], Any, int, List[int], int, List[str], Iterator[str]]: ...
