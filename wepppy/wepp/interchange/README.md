...
├── README.totalwatsed3.md              # Detailed totalwatsed3 sediment/baseflow/ash derivation notes
...
- [`README.totalwatsed3.md`](README.totalwatsed3.md) – Extended `totalwatsed3` semantics, derivations, and unit contracts
