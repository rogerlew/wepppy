...
def build_observed_prism(cligen: Cligen, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, prn_fn: str, cli_fn: str, gridmet_wind: bool = True, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> None: ...
def get_daymet_p_annual_monthlies(lng: float, lat: float, start_year: int, end_year: int) -> List[float]: ...
def build_observed_daymet(cligen: Cligen, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, prn_fn: str, cli_fn: str, gridmet_wind: bool = True, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> None: ...
def build_observed_daymet_interpolated(cligen: Cligen, topaz_id: str, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, cli_fn: str, prn_fn: str, wind_vs: Any | None = None, wind_dir: Any | None = None, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> Tuple[str, bool]: ...
def build_observed_snotel(cligen: Cligen, lng: float, lat: float, snotel_id: str, start_year: int, end_year: int, cli_dir: str, prn_fn: str, cli_fn: str, gridmet_supplement: bool = True, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> None: ...
def get_gridmet_p_annual_monthlies(lng: float, lat: float, start_year: int, end_year: int) -> List[float]: ...
def build_observed_gridmet(cligen: Cligen, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, prn_fn: str, cli_fn: str, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> None: ...
def build_observed_gridmet_interpolated(cligen: Cligen, topaz_id: str, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, cli_fn: str, prn_fn: str, adjust_mx_pt5: bool = False, silent_pass_observed_quality_guard: bool = False) -> Tuple[str, bool]: ...
def build_future(cligen: Cligen, lng: float, lat: float, start_year: int, end_year: int, cli_dir: str, prn_fn: str, cli_fn: str, adjust_mx_pt5: bool = False) -> None: ...
...
class Climate(NoDbBase):
    ...
    @property
    def observed_quality_guard_summary_warning(self) -> str | None: ...
    @property
    ...
    @property
    def calendar_start_year(self) -> int | None: ...
    @property
