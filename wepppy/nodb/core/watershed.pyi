...
class Watershed(NoDbBase):
    ...
    @property
    def relief(self) -> str | None: ...
    def translator_factory(self) -> WeppTopTranslator: ...
    def build_channels(self, csa: float | None = None, mcl: float | None = None) -> None: ...
    def symlink_channels_map(self, flovec_src: str, netful_src: str, relief_src: str | None = None, chnjnt_src: str | None = None, *, as_cropped_vrt: bool = True, crop_window: Tuple[int, int, int, int] | None = None) -> None: ...
    @property
    def target_watershed_path(self) -> str: ...
    def find_outlet(self, watershed_feature: Optional[WatershedFeature] = ...) -> None: ...
    ...
    def build_subcatchments(
        self,
        pkcsa: str | None = None,
        boundary_touch_behavior: str | None = None,
    ) -> None: ...
