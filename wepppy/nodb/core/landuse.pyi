...
from wepppy.nodb.locales import LanduseDataset
...
class Landuse(NoDbBase):
    ...
    @property
    def mofe_buffer_selection(self) -> int | None: ...
    @mofe_buffer_selection.setter
    def mofe_buffer_selection(self, value: int | None) -> None: ...
    ...
    @property
    def landuseoptions(self) -> List[Dict]: ...
    @property
