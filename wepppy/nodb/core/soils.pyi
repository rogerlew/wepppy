...
class Soils(NoDbBase):
    ...
    raw_ssurgo_domsoil_d: Incomplete
    ssurgo_substitution_d: Incomplete
    soils: Incomplete
    ...
    def build(self, initial_sat: float | None = None, ksflag: bool | None = None, max_workers: int | None = None, retrieve_gridded_ssurgo: bool = True) -> None: ...
    @property
    def bd_d(self) -> Dict: ...
    @property
