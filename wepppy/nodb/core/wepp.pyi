...
class Wepp(NoDbBase):
    ...
    def report_return_periods(self, rec_intervals: Tuple[int, ...] = (50, 25, 20, 10, 5, 2), exclude_yr_indxs: List[int] | None = None, method: str = 'cta', gringorten_correction: bool = True, meoization: bool = True, exclude_months: List[int] | None = None, chn_topaz_id_of_interest: int | None = None, wait_for_inputs: bool = True) -> ReturnPeriods: ...
