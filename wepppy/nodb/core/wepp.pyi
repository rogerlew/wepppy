...
class Wepp(NoDbBase):
    ...
    if TYPE_CHECKING:
        ...
        @job_key.setter
        def job_key(self, value: str | None) -> None: ...
    ...
    def get_bootstrap_commits(self) -> List[Dict[str, Any]]: ...
    ...
    def minimum_channel_width_m(self, value: float) -> None: ...
    @property
    ...
    @property
    def ichout_override(self) -> int | None: ...
    @ichout_override.setter
    def ichout_override(self, value: int | str | None) -> None: ...
    @property
    ...
    def make_watershed_run(
        self,
        wepp_id_paths: Incomplete | None = None,
        output_options: Dict[str, Any] | None = None,
    ) -> None: ...
    def run_watershed(self) -> None: ...
    def post_discord_wepp_run_complete(self) -> None: ...
    def report_loss(self) -> Any: ...
    def report_return_periods(self, rec_intervals: Tuple[int, ...] = (50, 25, 20, 10, 5, 2), exclude_yr_indxs: List[int] | None = None, method: str = 'cta', gringorten_correction: bool = True, meoization: bool = True, exclude_months: List[int] | None = None, chn_topaz_id_of_interest: int | None = None, wait_for_inputs: bool = True, output_scope: str = "baseline") -> ReturnPeriods: ...
