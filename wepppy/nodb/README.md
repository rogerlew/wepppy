...
> **See also:** [AGENTS.md](../../AGENTS.md) for Working with NoDb Controllers and Module Organization Best Practices sections.

> Looking for coding ground rules? Start with [`style-guide.md`](../../docs/dev-notes/style-guide.md) for clarity and ergonomics expectations before diving into the NoDb specifics.
