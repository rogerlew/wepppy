...
__all__ = ["PRESET_WRITER_FLAG", "PresetPolicy", "PresetPolicyError", "PresetSnapshotCandidate", "PresetSnapshotError", "load_preset_policies", "materialize_preset_snapshot", "preset_writer_enabled", "resolve_preset_locale_projection", "resolve_preset_snapshot"]
...
def resolve_preset_locale_projection(authority_root: str | Path, config_filename: str, *, expected_config_sha256: str | None = ...) -> str | None: ...
