...
def resolve_builder_config(selections: BuilderSelections, *, registry: Registry | None = ..., base_config: Mapping[str, Mapping[str, CanonicalValue]] | None = ..., base_revision: str | None = ..., capability_schema_version: int = ...) -> ResolvedBuilderConfig: ...
