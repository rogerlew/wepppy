...
filepath = 'geodata/small_basin_input_data/2018_basins/carr_fire_perim_basins_utm10T.csv'
firename = 'carr_fire_burned'
fire_year = 2018
water_year = 2019
utmzn = 10
utmzs = 'T'
main_folder = '/media/helen/HelenData/wepppy_runs/FireRegions_NoFires/'
#############
...
config_filepath = '/home/helen/wepppy/wepppy/nodb/configs/run_fires_v2.cfg'
