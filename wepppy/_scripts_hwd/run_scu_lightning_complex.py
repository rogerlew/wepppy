...
filepath = 'geodata/small_basin_input_data/soberanes_fire_perim_basins.csv'
config_filepath = 'ca_hindcast_2016.cfg'
fire_year = 2020
water_year = 2021
base_name = '/home/helen/geodata/wepppy_runs/scu_lightning_complex/'
...
firename = 'scu_lightning_complex'
output_name = 'scu_lightning_complex_wepp_output.csv'
...
for i in range(len(df)):
    if __name__ == '__main__':
        projects = [
                    dict(wd='scu_lightning_complex' + str(i+1),
        ...
        for proj in projects:
            ...
            totwatsed = TotalWatSed(_join(ron.output_dir, 'totalwatsed2.txt'),
            ...
            os.chdir(folder_name)
            hillslopes_output = pd.read_csv('totalwatsed2.csv', names=['wy','sed_kg'], skiprows=5, usecols=[4,5])
