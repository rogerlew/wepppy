...
filepath = 'geodata/small_basin_input_data/soberanes_basins_from_fire_perimeter_0p1_to_45km2_extent500m.csv'
config_filepath = 'soberanes_fire.cfg'
fire_year = 2016
water_year = 2017
base_name = '/home/helen/geodata/wepppy_runs/soberanes_fire/'
...
firename = 'soberanes_fire'
output_name = 'soberanes_fire_wepp_output.csv'
...
for i in range(len(df)):
    try:
        if __name__ == '__main__':
            projects = [
                        dict(wd='soberanes_fire_basin_' + str(df.basin_id[i]),
