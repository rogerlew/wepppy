...
filepath = 'geodata/small_basin_input_data/soberanes_df_outlets_v5.csv'
...
for i in range(len(df)):
    if __name__ == '__main__':
        ...
        for proj in projects:
            ...
            wat.build_channels(csa=(df.DA_km2[i])/2, mcl=200)
            ...
            # df.postfire_sed_yield[i] = annual_sed_data.iloc[1]
            ...
            # df.precip_threshold_exceeded[i] = climate_data['thresh_intensity'].sum()
            ...
            print('----------------------------------------------------------------')
df['postfire_sed_yield'] = postfire_sed_yield
df['precip_threshold_exceeded'] = precip_threshold_exceeded
print(df)
