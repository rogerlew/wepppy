...
filepath = 'geodata/small_basin_input_data/dolan_fire_perimeter_basins_v4.csv'
config_filepath = 'dolan.cfg'
fire_year = 2020
water_year = 2021
base_name = '/home/helen/geodata/wepppy_runs/dolan_fire/'
...
firename = 'dolan_fire'
output_name = 'dolan_fire_wepp_output.csv'
