...
filepath = 'geodata/small_basin_input_data/creek_fire_perim_basins_v2.csv'
config_filepath = 'creek_fire.cfg'
fire_year = 2020
water_year = 2021
base_name = '/home/helen/geodata/wepppy_runs/creek_fire/'
...
firename = 'creek_fire'
output_name = 'creek_fire_wepp_output.csv'
