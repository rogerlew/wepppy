...
- **Partial observed years.** CLIGEN generates days whose observed PRN fields use the `9999` sentinel. Multiple-interpolated builders retain those generated future values and overlay each radiation, dewpoint, or wind series only through its finite observed prefix. Missing internal dates remain errors.
