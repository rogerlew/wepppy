...
``webservices.wmesque2`` for raster tiling). Modules are intentionally separated
so each service can be deployed on its own timeline or disabled entirely inside
a given stack.
